...
defaultInputHoleFilename='..\RoadServer\data_kmean\0-0-hole.in.txt';
addOptional(p,'ih',defaultInputHoleFilename);
defaultInputMeanFilename='input-mean.txt';
defaultInputMeanFilename='..\RoadServer\data_kmean\0-0-mean.in.txt';
...
C=textscan(inputHoleFile,'%f%f%f%f%d');
